...
/* ── FORMAL FORMS ── */
const FORMS={
  visitor:{title:'Visitor / Guest Registration',fields:[{l:'Visitor Full Name',p:'Full name of your guest',id:'f-vis-name'},{l:'Visitor Relationship to You',p:'e.g. Family, Friend, Business',id:'f-vis-rel'},{l:'Visiting Date',p:'',type:'date',id:'f-vis-date'},{l:'Visiting Time',p:'e.g. 2:00 PM – 5:00 PM',id:'f-vis-time'},{l:'Purpose of Visit',p:'e.g. Personal visit, birthday',id:'f-vis-purpose'},{l:'Vehicle Plate (if any)',p:'Leave blank if on foot',id:'f-vis-plate'},{l:'Parking Needed?',p:'Yes — requesting parking slot / No — no vehicle',id:'f-vis-parking'},{l:'Expected Arrival',p:'e.g. 2:00 PM',id:'f-vis-arrival'},{l:'Expected Departure',p:'e.g. 5:00 PM',id:'f-vis-depart'}]},
  parking:{title:'Guest Parking Sticker Request',fields:[{l:'Vehicle Owner Name',p:'Full name',id:'f-pk-owner'},{l:'Vehicle Make & Model',p:'e.g. Toyota Vios 2020',id:'f-pk-car'},{l:'Plate Number',p:'e.g. ABC 1234',id:'f-pk-plate'},{l:'Duration Needed',p:'e.g. 1 day, 1 week',id:'f-pk-dur'},{l:'Reason / Purpose',p:'Why the vehicle needs to park inside',id:'f-pk-reason'}]},
  gatepass:{title:'Gate Pass Request',fields:[{l:'Name of Person / Company',p:'Person or service company name',id:'f-gp-name'},{l:'Type of Entry',p:'e.g. Delivery, Repair, Construction',id:'f-gp-type'},{l:'Valid Date(s)',p:'e.g. April 20–22, 2026',id:'f-gp-dates'},{l:'Entry Time',p:'e.g. 8:00 AM – 5:00 PM',id:'f-gp-time'},{l:'Description of Items / Work',p:'What will be brought in or done',id:'f-gp-items'},{l:'Requesting Resident',p:'Your name and unit number',id:'f-gp-resident'}]},
...
function switchVTab(t){
  document.getElementById('vtab-exp').classList.toggle('on',t==='exp');document.getElementById('vtab-walk').classList.toggle('on',t==='walk');
  document.getElementById('vpanel-exp').style.display=t==='exp'?'':'none';document.getElementById('vpanel-walk').style.display=t==='walk'?'':'none';
}
